...
@Component({
  selector: 'app-cedarhistory',
  templateUrl: './cedarhistory.component.html',
  styleUrls: ['./cedarhistory.component.css']
})
export class CedarhistoryComponent implements OnInit { private data = [];
